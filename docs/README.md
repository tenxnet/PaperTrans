...
| ページ | 内容 |
| --- | --- |
| [プロジェクトREADME](../README.md) | 対応範囲とQuick Start |
| [MCPクライアント登録](mcp-client-setup.md) | ローカルクライアントとChatGPT Tunnelの接続手順 |
| [トラブルシューティング](troubleshooting.md) | ポート、Tunnel、macOS権限、成果物検出 |
...
| [OSSリリースチェックリスト](oss-release-checklist.md) | 公開前に残っている作業 |

## English

| Page | Purpose |
| --- | --- |
| [Project README](../README.en.md) | Scope and quick start |
| [MCP client setup](mcp-client-setup.md) | Local clients and the ChatGPT Tunnel path |
| [Troubleshooting](troubleshooting.md) | Ports, Tunnel setup, macOS permissions, and artifact discovery |

### Reference and maintainer documentation
...
| [OSS release checklist](oss-release-checklist.md) | Remaining work before public release |
