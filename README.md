...
> **リリース候補（v0.2.0-rc.1）** — 公式arXiv HTMLを安定経路とし、DoclingによるデジタルPDF取込を実験経路として追加しました。どちらも接続したMCPクライアントで日本語へ翻訳します。
...
- DoclingによるデジタルPDF取込はv0.2.0-rc.1の実験機能です。複雑なレイアウトでは読み順、数式、表を誤る可能性があります。
